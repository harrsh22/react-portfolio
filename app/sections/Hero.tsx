            ...
            <div className="mt-10 flex flex-col items-center justify-center sm:mt-0 z-30 pointer-events-auto">
                ...
                >                 
                    ...
                    <AnimatedTitle
                        ...
                        className={
                          "text-center text-[20px] font-medium leading-[1.2em] tracking-normal text-[#e4ded7] sm:text-[25px] md:text-[30px] lg:text-[35px]"
                        }
                        wordSpace={"mr-[5px]"}
                        charSpace={"mr-[0.001em]"}
                    />                 
                ...
                <div className="mt-6 z-30">
                    <a
                        href="https://drive.google.com/file/d/1K1qov5LeJvuVVbNCs5yMTAPnhgFWHb1n/view" // replace with your actual resume link
                        target="_blank"
